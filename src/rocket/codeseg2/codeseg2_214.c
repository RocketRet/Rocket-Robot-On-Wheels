...
void func_8005C210(struct unkfunc_8005C210* arg0) {
    ...
    func_8001FDB4(arg0->unk2A0->unk10, (struct GameObject* ) arg0, arg0->unk2A0->rotation, sp10);
    ...
    func_8001FDB4(arg0->unk2A0->unk10, (struct GameObject* ) arg0, arg0->unk2A0->rotation, sp20);
